          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ fontSize: '13px' }}>{account?.contact || '—'}</div>
              </div>
              <div>
                <div style={label}>PHONE</div>
                <div style={{ fontSize: '13px' }}>{account?.phone || '—'}</div>
              </div>
            </div>
            <div style={{ fontSize: '11px', color: '#8A99A3', marginTop: '14px' }}>
              To update your contact details, please reach out to our team.
            </div>
          </div>
